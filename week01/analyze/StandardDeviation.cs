...
public static class StandardDeviation
{
    ...
    // O Notation Analysis: O(n) Because there are two separate loops that each iterate through the list of numbers once.
    ...
    // O notation is O(n^2) because is a nested loop
    ...
    // O Notation is O(n) becasue is just one loop
}