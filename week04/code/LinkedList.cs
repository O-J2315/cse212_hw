...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        {
            newNode.Prev = _tail; // Connect node to tail
    ...
    public void RemoveTail()
    {
        ...
        {
            _tail.Prev!.Next = null; //Disconnect the node 
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If the location of 'value' is at the head of the list,we can call remove head
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If the location of 'value' is at the tail of the list, we call remove tail
                else if (curr == _tail)
                {
                    RemoveTail();
                }
