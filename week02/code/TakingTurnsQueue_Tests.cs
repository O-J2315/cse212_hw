...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Taking turns queue was not declared as a queue but as a list.
    // The queue was not properly using the Count property. Instead it was using Length which is not a property of List.
    ...
    // Defect(s) Found: The IsEmpty property was not created on the base class.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Code was not handling the case where a person has infinite turns.
